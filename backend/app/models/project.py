...
Used to persist project state on the server, avoiding passing large amounts of data between frontend interfaces.
"""
...
class Project:
    ...
    # Ontology info (filled after Interface 1 generation)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph info (filled after Interface 2 completion)
...
class ProjectManager:
    ...
    def get_project(cls, project_id: str) -> Optional[Project]:
        ...
        Returns:
            Project object, None if not found
        """
    ...
    def get_project_files(cls, project_id: str) -> List[str]:
        """Get paths of all files in the project"""
        files_dir = cls._get_project_files_dir(project_id)

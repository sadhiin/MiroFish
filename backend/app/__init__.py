...
def create_app(config_class=Config):
    ...
    # JSON encoding: ensure Chinese characters are displayed directly (not as \uXXXX)
    ...
    # Only log startup info in the reloader subprocess (avoid printing twice in debug mode)

...
def get_generate_status():
    ...
    try:
        ...
        # If simulation_id is provided, check if a completed report exists
        if simulation_id:
            existing_report = ReportManager.get_report_by_simulation(simulation_id)
            if existing_report and existing_report.status == ReportStatus.COMPLETED:
                return jsonify({
...
# ============== Report Progress and Sections Interface ==============
...
def get_report_sections(report_id: str):
    ...
    The frontend can poll this interface to get the generated section content
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Interview is unlocked only when the report is completed
...
def get_console_log(report_id: str):
    """
    Get Report Agent console logs (Plain text)

...
Manage parallel simulations on both Twitter and Reddit platforms
Use preset scripts + LLM intelligent generation of configuration parameters
"""
...
class SimulationState:
    ...
    def to_simple_dict(self) -> Dict[str, Any]:
        """Simplified state dictionary (for API return use)"""
        return {
            "simulation_id": self.simulation_id,
            "project_id": self.project_id,
            "graph_id": self.graph_id,
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation configuration parameters (time, activity, speech frequency, etc.)
        ...
        Args:
            ...
            parallel_profile_count: Number of profiles generated in parallel, default is 3
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No entities found that meet the criteria, please check if the graph is correctly constructed"
                self._save_simulation_state(state)
                return state
            ...
            # Pass in graph_id to enable Zep retrieval function for richer context
    ...
    def get_profiles(self, simulation_id: str, platform: str = "reddit") -> List[Dict[str, Any]]:
        """Get Agent Profile of the simulation"""
        state = self._load_simulation_state(simulation_id)
        if not state:
            raise ValueError(f"Simulation does not exist: {simulation_id}")
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                ...
                f"   - Run Twitter individually: python {scripts_dir}/run_twitter_simulation.py --config {config_path}\n"
                f"   - Run Reddit individually: python {scripts_dir}/run_reddit_simulation.py --config {config_path}\n"

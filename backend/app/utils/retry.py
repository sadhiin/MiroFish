            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    logger.warning(
                        ...
                        f"{current_delay:.1f}seconds before retrying..."
                    )
...
class RetryableAPIClient:
        ...
        for attempt in range(self.max_retries + 1):
            try:
                ...
                if attempt == self.max_retries:
                    logger.error(f"API call at {self.max_retries} retries still failed: {str(e)}")
                    raise
    ...
    def call_batch_with_retry(
        ...
        Args:
            ...
            process_func: Processing function, takes single item as argument
            exceptions: Exception types to retry
            continue_on_failure: Whether to continue processing other items after single failure
